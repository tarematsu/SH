...
export const MATERIALIZED_API_VARIANTS = Object.freeze([
  ...
  Object.freeze({ key: 'track-likes', url: '/api/track-likes', cadence_minutes: 15 }),
  Object.freeze({ key: 'like-ranking', url: '/api/like-ranking', cadence_minutes: 15 }),
  ...
  Object.freeze({ key: 'host-history:summary', url: '/api/host-history?mode=summary', cadence_minutes: 15 }),
]);
