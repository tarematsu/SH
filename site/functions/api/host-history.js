...
export async function onRequestGet({ request, env }) {
  ...
  try {
    ...
    if (mode === 'session') {
      ...
      const [sessionResult, snapshots, queues, tracks, comments, events] = await env.OTHER_DB.batch([
        ...
        env.OTHER_DB.prepare(`SELECT comment_id,observed_at,account_id,handle,text,
        ...
        env.OTHER_DB.prepare(`SELECT observed_at,channel,event,data_json
