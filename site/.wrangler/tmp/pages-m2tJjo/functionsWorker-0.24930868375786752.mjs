...
async function onRequestGet2(context) {
  const result = await context.env.DB.prepare("SELECT COUNT(*) AS count FROM snapshots").first();
  return Response.json({
    ok: true,
...
// ../.wrangler/tmp/pages-m2tJjo/functionsRoutes-0.002977419443016549.mjs
var routes = [
  {
...
// ../.wrangler/tmp/bundle-dpJfVs/middleware-insertion-facade.js
...
// ../.wrangler/tmp/bundle-dpJfVs/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.24930868375786752.mjs.map
