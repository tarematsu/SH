...
test('production derive batches two revision tracks and two Queue messages', () => {
  ...
  assert.deepEqual(config.queues.consumers.map(({ max_batch_size }) => max_batch_size), [2, 2]);
});
