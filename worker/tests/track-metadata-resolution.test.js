...
test('track metadata migration creates Spotify, ISRC and dictionary repair paths', () => {
  ...
  assert.equal(metadata.schema, 'database/facts-migrations/033_fix_payload_clearable_transitions.sql');
});
